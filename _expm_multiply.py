"""The scipy routine still doesn't work for sparse operators.

See: https://github.com/scipy/scipy/issues/5103

We fix this here/use a workaround.

"""
import numpy as np

from scipy.sparse.linalg.interface import IdentityOperator
from scipy.sparse.linalg._expm_multiply import (_expm_multiply_interval_core_0,
...
from norm import estimate_1norm


def mock_trace(a, **kwargs):
...
def _expm_multiply_simple(A, B, t=1.0, balance=False):
    ...
    u_d = 2**-53
    tol = u_d
    mu = mock_trace(A) / float(n)
    A = A - mu * ident
    A_1_norm = estimate_1norm(A, t=10)
    if t*A_1_norm == 0:
        m_star, s = 0, 1
    else:
        ell = 2
